...
COPY root /
RUN dnf install -y hostname xorg-x11-drv-evdev xorg-x11-xinit xorg-x11-server-Xorg xorg-x11-drv-intel i3 vim which findutils procps-ng openssl git which && \
